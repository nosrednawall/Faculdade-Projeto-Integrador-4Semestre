...
WHERE PERGUNTAS_EMPRESA.ID_EMPRESA = '$id_empresa' AND PERGUNTAS_EMPRESA.ID_PERGUNTA = VAGA_CRIADA.ID_PERGUNTA1 AND VAGA_CRIADA.STATUS LIKE 'ATIVA'");
...
<body> <!-- Começo do Body -->
	...
	<div class="jumbotron">
		<br>
		<div class="container">
			<h3>Visualize ou inative as suas vagas</h3>
		</div> <!--/container -->
	</div> <!--jumbotron -->
	<div class="container">
		<div class="row">
									...
									while($res = mysqli_fetch_array($result)) {
										echo "<tr>";
											...
											echo "<td><a href=\"empresa_editar_vaga.php?ID_VAGAC=$res[ID_VAGAC]\" class=\"btn btn-xs btn-warning\" role=\"button\">Editar</a> |
											 <a href=\"_php/manter-vaga/inativar_vaga.php?ID_VAGAC=$res[ID_VAGAC]\"class=\"btn btn-xs btn-danger\" role=\"button\" onClick=\"return confirm('Você tem certeza que deseja inativar essa vaga?')\">	Inativar</a></td>";
										echo "</tr>";
									}
								 ?>
							</tbody>
