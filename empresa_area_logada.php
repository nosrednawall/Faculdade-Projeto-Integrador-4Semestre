...
<body> <!-- Começo do Body -->
	...
	<div class="jumbotron">
		...
		<div class="container">
      <div class="row">
        <?php echo "<h2>Seja bem-vindo, ".$_SESSION["razao_social"]."</h2>"; ?>
      </div>
      <br>
    </div> <!--/container -->
	</div> <!--jumbotron -->
	...
	<article class="container">
        ...
        <p><a href="empresa_manter_vagas.php" class="btn btn-primary btn-lg btn-block" role="button" >Gerenciar Vagas</a></p>
			</div> <!--/col -->
			<div class="col-sm-4 col-lg-4">
        <div class="well">
				      <h3>Altere suas informações</h3>
        </div>
          <p><a href="empresa_editar.php" class="btn btn-primary btn-lg btn-block" role="button" >Alterar informações</a></p>
			</div>

			<div class="col-sm-4 col-lg-4">
        <div class="well">
				      <h3>Gerencie suas perguntas</h3>
        </div>
          <p><a href="empresa_manter_perguntas.php" class="btn btn-primary btn-lg btn-block" role="button" >Gerenciar Perguntas</a></p>
			</div>
		</div> <!--/row -->
	</article>
	<hr>
