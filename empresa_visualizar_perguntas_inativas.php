...
$result = mysqli_query($mysqli, "SELECT PERGUNTAS_EMPRESA.ID_PERGUNTA,PERGUNTAS_EMPRESA.PERGUNTA,PROFISSAO.NOME,PROFISSAO.AREA,PERGUNTAS_EMPRESA.STATUS FROM PERGUNTAS_EMPRESA,PROFISSAO
	WHERE PERGUNTAS_EMPRESA.ID_EMPRESA = '$id_empresa' AND PERGUNTAS_EMPRESA.ID_PROFISSAO = PROFISSAO.ID_PROFISSAO AND PERGUNTAS_EMPRESA.STATUS LIKE 'INATIVA'");
								...
								<?php
									while($res = mysqli_fetch_array($result)) {
										echo "<tr>";
											...
											echo "<td><a href=\"empresa_editar_perguntas.php?ID_PERGUNTA=$res[ID_PERGUNTA]\" class=\"btn btn-xs btn-warning\" role=\"button\">Editar</a> |
											 <a href=\"_php/manter-empresa/ativar_pergunta.php?ID_PERGUNTA=$res[ID_PERGUNTA]\"class=\"btn btn-xs btn-success\" role=\"button\" onClick=\"return confirm('Você tem certeza que deseja ativar essa pergunta?')\">	Ativar</a></td>";
										echo "</tr>";
									}
								 ?>
								 </tbody>
