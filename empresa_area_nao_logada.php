...
<body> <!-- Começo do Body -->
	...
	<div class="jumbotron">
		...
		<div class="container">
			<h2>Caro Parceiro</h2>
			<p>Abaixo estão os botões para efetuar login ou solicitar contato.<p>
		</div> <!--/container -->
	</div> <!--jumbotron -->
	...
	<article class="container jumbotron"> <!--inicio do article -->
		<div class="row"> <!-- incio da linha-->
			<div class="col-sm-6 col-md-4 col-lg-4"> <!-- inicio das colunas nessa primeira linha-->
				...
				<form class="form-signin" method="post" action="_php/manter-empresa/loga_empresa.php">
					<fieldset><legend>Login e senha</legend>
						<label for="inputEmail" class="sr-only">Email address</label>
						<input type="email" id="inputEmail" class="form-control" placeholder="Email address" required autofocus size="20" name="php_email_empresa">
			...
			<div class="col-sm-6 col-md-4 col-lg-6"> <!-- outra coluna nessa mesma linha-->
				<h3>Não possui cadastro conosco? então solicite contato agora</h3>
				<p><a class="btn btn-primary btn-lg" onclick="location.href='empresa_solicitar_contato.html'" role="button">Solicitar contato &raquo;</a></p>
			</div><!--/col -->
		</div> <!--/row -->
	</article> <!-- /conteiner -->
