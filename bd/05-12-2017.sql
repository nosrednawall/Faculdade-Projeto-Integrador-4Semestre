...
--
-- Host: localhost:3306
-- Generation Time: 05-Dez-2017 às 18:21
...
(1, 'ADMIN', 'admin@trabalheconosco.com', '123'),
(2, 'ANDERSON', 'anderson@trabalheconosco.com', '123');
...
INSERT INTO `CANDIDATO` (`ID_CANDIDATO`, `CPF`, `RG`, `NOME`, `NOME_SOCIAL`, `DATA_NASCIMENTO`, `ESTADO_CIVIL`, `SEXO`, `QTD_FILHOS`, `STATUS`, `ESCOLARIDADE`, `LINGUAS`, `CNH`, `ID_PROFISSAO`, `ENDERECO`, `NUMERO_CASA`, `COMPLEMENTO`, `CEP`, `BAIRRO`, `CIDADE`, `ESTADO`, `PAIS`, `TEL_RESIDENCIAL`, `TEL_CELULAR`, `TEL_RECADO`, `EMAIL`, `SENHA_CANDIDATO`) VALUES
(11, 11111111, 22222222, 'Pessoa para teste', 'Teste', '1950-12-11', 'SEPARADO(A)', 'M', 10, 'ATIVO', 'ENSINO FUNDAMENTAL INCOMPLETO', 'INGLES', 'A', 6, 'rua mario wilson partes', 803, 'CASA', '83085340', 'joanopulis', 'sao jose dos pinhais', 'PR', 'BRA', '9999999999', '99999999', '9999999999', 'teste@teste.com', 'abc');
...
(1, 'Severino', 'batata', 1, 41, 41, 39, 38, 40, 'INATIVA'),
(2, 'vaga', 'vaga vaga', 1, 41, 41, 41, 41, 41, 'ATIVA'),
(3, 'ola mundo', 'ola mundo', 1, 42, 37, 40, 38, 41, 'ATIVA');
...
--
ALTER TABLE `CANDIDATO`
  MODIFY `ID_CANDIDATO` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
