...
$result = mysqli_query($mysqli, "SELECT * FROM VAGA_CRIADA , CANDIDATO , QUESTIONARIO WHERE CANDIDATO.ID_CANDIDATO = '$id_candidato' AND QUESTIONARIO.STATUS LIKE 'PENDENTE' AND VAGA_CRIADA.STATUS LIKE 'ATIVA'");
//$result = mysqli_query($mysqli, "SELECT * FROM VAGA_CRIADA WHERE VAGA_CRIADA.STATUS = 'ATIVA'");
?>
<!DOCTYPE html>
								...
								<?php
									while($res = mysqli_fetch_array($result)) {
										echo "<tr>";
											...
											echo "<td>".$res['AREA_VAGA']."</td>";
											echo "<td>".$res['DESCRICAO']."</td>";
											//echo "<td>".$res['QTDA_OFERTADA']."</td>";
											
											echo "<td>".$res['STATUS']."</td>";
											echo "<td><a href=\"candidato_logado_vagas_quest.php\" class=\"btn btn-xs btn-success\" role=\"button\">QUESTIONARIO</a></td>";
