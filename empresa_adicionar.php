...
{
 //   $id = $res['ID'];
	$razao_social = $res['NOME_EMPRESA'];
	$email_empresa = $res['EMAIL_EMPRESA'];
}
?>
...
<body> <!-- Começo do Body -->
	...
	<div class="row">
	    ...
	    <article class="">
				<form method="post" action="_php/manter-empresa/adiciona_empresa.php">
					<div class="row">
						<div class="col-sm-6 col-lg-2">
							<fieldset><legend>Dados Juridicos</legend>
								<label id="css_cnpj">CNPJ</label>
								</br>
								<input id="css_cnpj" name="php_cnpj" type="text" max="20" maxlength="20"/>
								</br>
								...
								<input id="css_nomefantasia" name="php_nome_fantasia" type="text" max="100" maxlength="30"/>
								</br>
								<label id="css_telefone">Telefone</label>
								</br>
								<input id="css_telefone" name="php_telefone" type="text" max="20" maxlength="20"/>
								</br>
								<label id="css_site">Site</label>
								</br>
								<input id="css_site" name="php_site" type="text" max="100" maxlength="30"/>
								</br>
							</fieldset>
						</div> <!--/col -->
						<div class="col-sm-6 col-lg-2">
							<fieldset><legend>Endereço</legend>
								...
								<input id="css_cep" name="php_cep" type="text" max="10" maxlength="10"/>
								</br>
								<label id="css_endereco">Endereço</label>
								</br>
								<input id="css_endereco" name="php_endereco" type="text" max="100" maxlength="30"/>
								</br>
								<label id="css_numero_empresa">Numero estabelecimento</label>
								</br>
								<input id="css_numero_empresa" name="php_numero_empresa" type="text" max="20" maxlength="20"/>
								</br>
								<label id="css_complemento">Complemento</label>
								</br>
								<input id="css_complemento" name="php_complemento" type="text" max="100" maxlength="30"/>
								</br>
								<label id="css_bairro">Bairro</label>
								</br>
								<input id="css_bairro" name="php_bairro" type="text" max="100" maxlength="30"/>
								</br>
								<label id="css_cidade">Cidade</label>
								</br>
								<input id="css_cidade" name="php_cidade" type="text" max="100" maxlength="30"/>
								</br>
								<label for="css_estado">Estado</label>
								</br>
								<input id="css_estado" name="php_estado" list="lista_estados" placeholder="Informe o estado de vossa localidade" />
								...
								<input id="css_pais" name="php_pais" list="lista_pais" placeholder="Por enquanto atuamos apenas no Brasil" />
						...
						<div class="col-sm-6 col-lg-2">
							<fieldset><legend>Login e senha</legend>
								...
								<input id="css_email_empresa" name="php_senha" type="password"  />
							</fieldset>
						</div> <!--/col -->
					</div> <!--/row -->
					<div class="row">
						<div class="col-md-4 col-lg-4 col-lg-offset-2">
							...
							<input type="button" value="Voltar" onclick="location.href='ADM_empresa_manter_futuro_parceiro.php'">
							<input type="reset" value="Limpar" />
							<input type="hidden" name="ID_EFP" value="<?php echo"$id"; ?>" />
						</div>
					</div>
				</form> <!-- fim da form-->
