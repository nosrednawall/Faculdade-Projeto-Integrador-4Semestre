				...
				<div class="col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-4"> <!-- div responsável por deixar o texto no meio -->
					...
					<div class="row">
						...
						<div class="form-group">
							<fieldset id="css_formulario-dados-pessoais"><legend>Dados pessoais</legend>
								<!-- inserir dados da pessoa de contato nosso -->
									...
									<br>
									<input type="text" name="php_nomecandidato" id="css_nome-candidato" size="20" maxlength="100"	 value="<?php echo"$nomecandidato"; ?>" required/>
									<br>
									<label for="css_nomesocial">Nome social</label>
									<br>
									<input type="text" name="php_nomesocial" id="css_nomesocial" size="20" maxlength="100"	value="<?php echo"$nomecandidato"; ?>" required/>
									<br>
									<label for="css_cpf-candidato">CPF</label>
									<br>
									<input type="text"  name="php_cpfcandidato" id="css_cpf-candidato" size="11" maxlength="11"	 value="<?php echo"$cpfcandidato"; ?>" required/>
									<br
									<label for="css_rg-candidato">RG</label>
									<br>
									<input type="text" name="php_rgcandidato" id="css_rg-candidato" size="9" maxlength="9"	 value="<?php echo"$rgcandidato"; ?>" required/>
									<br>
									<label for="css_datanascimento">Data de Nascimento</label>
									<br>
									<input id="css_datanascimento" name="php_datanascimento"  type="date"  value="<?php echo"$datanascimento"; ?>"/>
									<br>
									<label for="css_sexo">Sexo</label>
									<br>
									<input id="css_sexo" list="lista-sexo" name="php_sexo" placeholder="Escolha uma das opções" value="<?php echo"$sexo"; ?>"/>
									...
									<br>
									<input id="css_estado-civil" list="lista-estados-civis" name="php_estadocivil" placeholder="Ex: casado(a)" value="<?php echo"$estadocivil"; ?>"/>
									...
									<br>
									<input id="css_qtda-filhos" name="php_qtdafilhos" placeholder="Ex: 0" type="number" min="0" max="99" value="<?php echo"$qtdafilhos"; ?>"/>
									</br>
									<label for="css-tipo-cnh">Tipo de CNH</label>
									<br>
									<input id="css-tipo-cnh" list="lista-tipo-cnh" name="php_cnh" placeholder="Ex: Carteira A Moto" value="<?php echo"$cnh"; ?>"/>
						...
						<div class="form-group">
							<fieldset id="css_formulario-endereco"><legend>Endereço</legend> <!-- fieldset para inserir os dados de endereco -->
								...
								<br>
								<input id="css_cep-candidato" name="php_cepcandidato" required  maxlength="9" type="text" value="<?php echo"$cepcandidato"; ?>"/>
								</br>
								<label for="css_endereco-candidato">Endereço</label>
								<br>
								<input id="css_endereco-candidato" name="php_enderecocandidato" required maxlength="100" type="text" value="<?php echo"$enderecocandidato"; ?>"/>
								</br>
								<label for="css_numero-endereco-candidato">Numero</label>
								<br>
								<input id="css_numero-endereco-candidato" name="php_numeroendereco" required maxlength="20" value="<?php echo"$numeroendereco"; ?>"/>
								</br>
								<label for="css_complemento">Complemento</label>
								<br>
								<input id="css_complemento" name="php_complemento" maxlength="100" type="text" value="<?php echo"$complemento"; ?>"/>
								</br>
								<label for="css_bairro-candidato">Bairro</label>
								<br>
								<input id="css_bairro-candidato" name="php_bairro" maxlength="100" type="text" value="<?php echo"$bairro"; ?>"/>
								</br>
								<label for="css_cidade-candidato">Cidade</label>
								<br>
								<input id="css_cidade-candidato" name="php_cidade" type="text" maxlength="100" value="<?php echo"$cidade"; ?>"/>
								</br>
								<label for="css_estado-candidato">Estado</label>
								<br>
								<input id="css_estado-candidato" name="php_estado" list="listaestados-candidato" placeholder="Informe o estado onde você vive atualmente" value="<?php echo"$estado"; ?>"/>
								...
								<br>
								<input id="css_pais-candidato" name="php_pais" list="listapais-candidato" placeholder="Por enquanto atuamos apenas no Brasil" value="<?php echo"$pais"; ?>"/>
					...
					<div class="row">
						<div class="form-group">
							<fieldset id="css_contato"><legend>Contato</legend>
								...
								<br>
								<input id="css_celular-contato" name="php_celular" type="text" maxlength="10" placeholder="Campo obrigatório" value="<?php echo"$celular"; ?>" required/>
								</br>
								<label id="css_tel-residencial">Telefone Residencial</label>
								<br>
								<input id="css_tel-residencial" name="php_tel_residencial" type="text" maxlength="10" placeholder="Campo não obrigatório" value="<?php echo"$tel_residencial"; ?>"/>
								</br>
								<label id="css_tel-recado">Telefone para recado</label>
								<br>
								<input id="css_tel-recado" name="php_tel_recado" type="text" maxlength="10" placeholder="Campo não obrigatório" value="<?php echo"$tel_recado"; ?>"/>
								</br>
							</fieldset>
						</div>
						<div class="form-group">
							<fieldset id="css_coisas a mais"><legend>Currículo breve</legend>
								...
								<br>
								<input id="css_escolaridade" name="php_escolaridade" list="lista-escolariedade" value="<?php echo"$escolaridade"; ?>"/>
								...
								<br>
								<input type="text" name="php_linguas" id="css_linguas" value="<?php echo"$linguas"; ?>" />
								</br>
								<label id="css_areapretendida">Áreas pretendidas</label>
								<br>
								<input type="text" name="php_areapretendida" id="css_areapretendida" value="<?php echo"$areapretendida"; ?>" />
								</br>
							</fieldset>
						</div><!--/col -->
						<div class="form-group">
				        ...
				        <label id="css_email-candidato">E-mail</label>
								<br>
								<input id="css_email-candidato" name="php_emailcandidato" type="email" maxlength="100" required value="<?php echo"$emailcandidato"; ?>"/>
								<br>
								<label id="css_senha_candidato">Senha</label>
								<br>
								<input id="css_senha_candidato" name="php_senha" type="text" maxlength="100" required  value="<?php echo"$senha"; ?>" />
								</br>
							</fieldset>
						</div><!--/col -->
					</div><!--/row -->
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-2">
							<div class="container">
								<input type="submit" value="Salvar" name="css_enviar-dados" id="php_enviar-dados" class="input-formulario"/>
