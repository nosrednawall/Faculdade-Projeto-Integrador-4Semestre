...
/*///////////////////////////////////////////////////////////
////////////Faz o select das empresas inativas /////////////
/////////////////////////////////////////////////////////*/
$result = mysqli_query($mysqli, "SELECT * FROM `CANDIDATO` WHERE `STATUS` = 'INATIVO' "); // using mysqli_query instead
?>
...
<body> <!-- Começo do Body -->
	...
	<div class="jumbotron">
		<br>
		<div class="container">
			<h2>Gerenciar candidatos cadastrados no site</h2>
		</div> <!--/container -->
	</div> <!--jumbotron -->
	            ...
	            <table width='80%' border=0 class="table-striped">
	                ...
	                <?php
	                    while($res = mysqli_fetch_array($result)) {
		                      ...
		                      //echo "<td><a href=\"candidato_editar.php?ID=$res[ID_CANDIDATO]\">Alterar</a> | <a href=\"_php/manter-candidato/ativar_candidato.php?ID=$res[ID_CANDIDATO]\"onClick=\"return confirm('Você tem certeza que deseja ativar esse candidato?')\">Ativar</a></td>";
														echo "<td><a href=\"candidato_editar.php?ID=$res[ID_CANDIDATO]\"class=\"btn btn-xs btn-warning\" role=\"button\">Alterar</a> | <a href=\"_php/manter-candidato/ativar_candidato.php?ID=$res[ID_CANDIDATO]\" class=\"btn btn-xs btn-danger\" role=\"button\" onClick=\"return confirm('Você tem certeza que deseja ativar esse candidato?')\">	Ativar</a></td>";
													echo "</tr>";
	                    }
	                ?>
	            </table>
