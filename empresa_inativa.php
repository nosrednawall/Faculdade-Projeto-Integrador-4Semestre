...
/////////////////////////////////////////////////////////*/
$result = mysqli_query($mysqli, "SELECT * FROM `EMPRESA` WHERE `STATUS_CADASTRO` = 'INATIVO' "); // using mysqli_query instead
?>
...
<body> <!-- Começo do Body -->
	...
	<div class="jumbotron">
		<br>
		<div class="container">
			<h2>Listagem de empresas cadastradas com status INATIVO</h2>
		</div> <!--/container -->
	</div> <!--jumbotron -->
	           	...
	           	while($res = mysqli_fetch_array($result)) {
	            	echo "<tr>";
			            ...
			            echo "<td>".$res['NOME_FANTASIA']."</td>";
			                        ...
			                        //echo "<td><a >Alterar</a> | <a >Ativar</a></td>";
									echo "<td><a href=\"empresa_editar.php?ID=$res[ID_EMPRESA]\" class=\"btn btn-xs btn-warning\" role=\"button\">Alterar</a> | <a href=\"_php/manter-empresa/ativar_empresa.php?ID=$res[ID_EMPRESA]\"class=\"btn btn-xs btn-danger\" role=\"button\" onClick=\"return confirm('Você tem certeza que deseja ativar essa empresa?')\">	Ativar</a></td>";
								echo "</tr>";
	            }
	           ?>
	       	</table>
